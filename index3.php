...
<br>
     <!--   <div class="panel panel-default">
        ...
        <div class="container" id="subir-foto">
            <p><small>Subi tu foto de Daniel Agostini para compartirla con toda la comunidad Agostinera !</small></p>
        

        <button type="button" class="btn btn-info btn-block" data-toggle="collapse" data-target="#formsubir">Soy tu fan</button>
        ...
        <!--
        <button  id="ver_subir_foto" class="btn btn-info btn-block" data-toggle="collapse" data-target="#fotin">Soy tu Fan</button>
        ...
        <button type="button" class="btn btn-info btn-block" data-toggle="collapse" data-target="#gal">Ver Galeria</button>
          <div id="gal" class="collapse ">
...
<br>
<!--
<div class="container" id="mostrar_galeria">
