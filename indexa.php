...
<section id="subefoto">
     <!-- data-toggle="collapse" data-target="#formsubir" -->
        <p><small>Subi tu foto de Daniel Agostini para compartirla con toda la comunidad Agostinera !</small></p>
        
        <a class="btn btn-info btn-block" id="fan" >Soy tu fan</a>   
        <a class="btn btn-info btn-block" id="c_fan" >Cerrar carga</a> 

          <div id="formsubir" >
            <?php include('subir/index.php'); ?>
          </div>  <br>




        <a  class="btn btn-info btn-block" id="gal">Ver Galeria</a>
        <a  class="btn btn-info btn-block" id="c_gal">Cerrar Galeria</a>

          <div id="ver_gal" class="collapse ">
            <p><h5>Galería de imágenes</h5></p>
                <?php
...
// y ajustar los divs a su diseño, lo importante es el codigo php
     ...
     <!--   <div class="panel panel-default">
        ...
        <button data-toggle="collapse" data-target="#fotin" id="ver_subir_foto" class="btn btn-info btn-block">Soy tu Fan</button>

            <div id="fotin" class="collapse">
...
<div id="galeria" class="galeria collapse">
